...
export const Header = () => {
  ...
  useEffect(() => {
    ...
    const handleLoginEvent = () => setStatus(true);
    const handleLogoutEvent = () => setStatus(false);
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item nav-pill">
              <Link className="nav-link text-white" to="/tribute-page">
                Tribute Page
              </Link>
            </li>
          </ul>
          ...
          <ul className="navbar-nav">
            {status ? (
              <li className="nav-item dropdown">
                <button
                  className="btn btn-danger dropdown-toggle nav-button"
                  id="userMenu"
                ...
                >
                  <li>
                    <button className="dropdown-item" onClick={addBlog}>
                      ➕ Add Blog
                    </button>
                  </li>
                  <li>
                    <button className="dropdown-item" onClick={goToBlogList}>
                      📚 Blog List
                    </button>
                  </li>
                  <li>
